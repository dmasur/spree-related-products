...
desc 'Generate documentation for the related_products extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'RelatedProductsExtension'
...
desc 'Test the related_products extension.'
...
namespace :test do
  desc 'Functional test the related_products extension.'
  ...
  desc 'Unit test the related_products extension.'
